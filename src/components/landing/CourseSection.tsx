...
const deliveries: Item[] = [
  ...
  { 
    title: "Acesso Discreto e Seguro", 
    icon: EyeOff,
    description: "Assista em qualquer dispositivo com total privacidade e segurança dos seus dados."
  },
  { 
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mt-24">
            <h3 className="text-3xl lg:text-5xl font-black text-white uppercase">
                E ainda <span className="text-primary">Bônus Exclusivos</span>
            </h3>
        </div>
